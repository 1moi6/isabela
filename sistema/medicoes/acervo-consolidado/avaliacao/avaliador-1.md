# Avaliação de questões — avaliador 1
...
Você pode responder direto neste documento ou na planilha `respostas-avaliador-1.csv`, que já
...
(a) O gráfico é um segmento horizontal em $C=25$ para $0 \le x \le 10$; em seguida uma semirreta de coeficiente angular $3{,}5$ unindo $(10;25)$ a $(25;77{,}5)$; e por fim uma semirreta de coeficiente angular $5$ unindo $(25;77{,}5)$ a $(35;127{,}5)$. A função é constante em $[0,10]$ e crescente em $(10,35]$, com imagem $[25;\,127{,}5]$.
...
**Gabarito proposto:** Alternativa A — $C$ é constante ($=25$) em $[0,10]$, crescente em $(10,35]$ (inclinação $3{,}5$ até $x=25$ e depois $5$), com imagem $[25;\,127{,}5]$.
...
**Gabarito proposto:** C(d) = 3d + 6; custo para 15 km = R$ 51,00; distância para R$ 81,00 = 25 km
...
**Gabarito proposto:** y = 2x + 5 (alternativa A)
...
**Gabarito proposto:** f(n) = 4n + 3, com domínio $\mathbb{N}^* = \{1,2,3,\dots\}$; $a_{20} = 83$
...
**Gabarito proposto:** a) PG de razão $q=2$ e $a_1=200$; b) $f(n)=200\cdot 2^{n-1}$, com domínio $D=\{1,2,3,\dots\}$ (naturais, pois $n$ conta horas); c) $a_6 = f(6) = 6400$ bactérias.
...
(a) R é uma função afim não proporcional ($y=2x+3$), cujo gráfico é uma reta paralela a $y=2x$, deslocada 3 unidades para cima, não passando pela origem; S é uma função linear (proporcional), pois sua lei é $y=2x$, coincidindo com a própria reta $y=2x$ e passando pela origem do plano cartesiano.
...
**Gabarito proposto:** R é uma função afim não proporcional ($y=2x+3$), cujo gráfico é paralelo a $y=2x$ mas deslocado 3 unidades para cima, não passando pela origem; S é uma função linear (proporcional), pois $y=2x$ coincide com a própria reta $y=2x$, passando pela origem.
...
**Gabarito proposto:** R$ 50,00 (alternativa a)
...
**Gabarito proposto:** a) $f(x)=20$ se $0\le x\le 10$; $f(x)=3x-10$ se $10<x\le 20$; $f(x)=5x-50$ se $x>20$. b) $D(f)=[0,+\infty)$. c) 17 m³. d) constante em $[0,10]$; crescente em $(10,20]$ e em $(20,30]$ (com inclinação maior nesse último trecho). e) Imagem $=[20,100]$.
...
**Gabarito proposto:** a) $M(t) = 6000\cdot(1,04)^t$; b) $M(10) \approx R\$\,8.881{,}47$; c) menor número inteiro de meses: $t = 18$ (contra 25 meses no regime linear equivalente, evidenciando o crescimento exponencial).
...
(a) $h(t) = 22 - 20\cos\left(\dfrac{\pi t}{6}\right)$, e a altura é maior que 32 m para $t \in (4, 8)$ minutos.
...
**Gabarito proposto:** h(t) = 22 - 20cos(πt/6); altura > 32 m para t entre 4 e 8 minutos (alternativa A)
