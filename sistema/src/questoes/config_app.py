...
PADRAO: dict[str, str] = {
    ...
    "chave_admin": "",
    # Quantas gerações um convite marcado com `usa_chave_do_servidor` pode pagar
    # com a chave do dono. "0" = sem limite. Quem informa a própria chave no
    # navegador não é contabilizado: a cota limita gasto, não uso.
    "cota_por_convite": "10",
