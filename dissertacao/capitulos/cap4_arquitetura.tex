...
\begin{itemize}
\item \textbf{Tema} --- o tópico matemático, dentro do recorte da dissertação: função afim,
  função quadrática, função exponencial, progressão aritmética ou progressão geométrica.
\item \textbf{Habilidade BNCC} --- o código da habilidade (por exemplo, \texttt{EM13MAT302}),
  ...
  entrada, antes de qualquer chamada ao LLM.
