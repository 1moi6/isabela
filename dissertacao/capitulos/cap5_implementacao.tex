...
de avaliação por painel docente, é objeto do capítulo de avaliação; e o \textbf{Ciclo 4}
...
contratos de dados validados por esquema; \textbf{Streamlit} para a interface web do professor;
...
|- app/streamlit_app.py             # interface do professor
|- tests/                           # 36 testes automatizados
\end{verbatim}
...
\textbf{temperatura} padrão dos provedores é 0,3 --- baixa, conforme a discussão da
Seção~\ref{sub:inferencia}. Segundo, todo ciclo é registrado em \emph{log} JSONL com os objetos
completos de cada iteração, permitindo reconstruir qualquer execução. Terceiro, os
