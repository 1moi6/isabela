...
do sistema desenvolvido nesta dissertação, questão retomada no capítulo de implementação.
...
conceituais do trabalho. O Agente Verificador Simbólico, descrito no capítulo de arquitetura, opera
...
A decisão final entre LangGraph e CrewAI --- os dois candidatos mais aderentes ao sistema proposto ---
é apresentada e justificada no capítulo de implementação, após a discussão dos requisitos.
