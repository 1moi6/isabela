...
discreto). A esses dois agrupamentos somam-se, pela mesma lógica e igualmente por analogia, as
habilidades de funções logarítmicas (\texttt{EM13MAT305} e \texttt{EM13MAT403}),
trigonométricas (\texttt{EM13MAT306} e \texttt{EM13MAT404}) e definidas por várias sentenças
(\texttt{EM13MAT405}). O recorte totaliza, portanto, quinze habilidades, cobrindo funções afins,
quadráticas, exponenciais, logarítmicas, trigonométricas e por partes, além das duas progressões.

O recorte não é, contudo, uma linha entre habilidades verificáveis e não verificáveis. Cinco das
quinze adotadas --- \texttt{EM13MAT401}, \texttt{EM13MAT402}, \texttt{EM13MAT403},
\texttt{EM13MAT404} e \texttt{EM13MAT405} --- pedem converter ou comparar representações, e o que
a habilidade cobra aí é uma propriedade do enunciado, não do cálculo: nenhum sistema de computação
algébrica decide se a questão de fato exige o trânsito entre registros. Elas integram o recorte
declarando conferência apenas parcial, conforme a garantia discutida na
Seção~\ref{sec:garantia}. É esse mecanismo que permite ampliar o catálogo sem que nenhuma
habilidade prometa mais do que entrega --- e é por isso que a delimitação a seguir é de
\emph{grau} de verificabilidade, e não de exclusão.
...
limites de formalização discutidos na Seção~\ref{sub:cas-limites}. Como o recorte é curricular e não meramente
