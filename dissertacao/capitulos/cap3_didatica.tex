...
articuladas, os pilares pedagógicos do sistema --- a perspectiva de Polya; a Teoria das Situações
...
Antes de apresentar a perspectiva de Polya, é necessário estabelecer uma distinção que atravessa toda
...
\subsection{A perspectiva de Polya}
\label{sub:polya}
...
\paragraph{Implicações para a elaboração de questões.} A heurística de Polya, embora concebida como
...
\citep{brousseau1997tsd}, oferece um quadro complementar ao de Polya. Enquanto a heurística de Polya
...
\texttt{EM13MATxxx}, em que os dois primeiros algarismos após \texttt{MAT} identificam a competência e
os últimos a habilidade --- funciona como identificador único e não ambíguo da expectativa de
...
% CORRIGIDO: o rascunho dizia "quatro unidades temáticas" mas listava
% três. O texto discute exatamente estas três. CONFERIR a nomenclatura
% e a contagem contra o documento da BNCC antes da versão final.
A área de Matemática e suas Tecnologias organiza seus conteúdos em três unidades temáticas:
\textbf{Números e Álgebra}, \textbf{Geometria e Medidas} e \textbf{Probabilidade e Estatística}
% CONFERIR contagem/nomenclatura na BNCC
\citep{brasil2018bncc}. A unidade \textbf{Números e Álgebra} abrange a interpretação e o uso de funções
(polinomiais, exponenciais, logarítmicas e trigonométricas), progressões aritméticas e geométricas e a
análise de situações de variação de grandezas; é a unidade com maior densidade de habilidades e maior
abrangência para a geração de questões com diferentes níveis cognitivos. A unidade \textbf{Geometria e
Medidas} contempla geometria plana e espacial, semelhança, trigonometria e transformações geométricas;
do ponto de vista da verificação simbólica, é a que apresenta maior proporção de habilidades de difícil
formalização computacional, correspondendo ao limite discutido na Seção~\ref{sub:cas-limites}. A unidade
\textbf{Probabilidade e Estatística} reúne análise combinatória, probabilidade, medidas de tendência
central e dispersão e interpretação de dados, sendo a de maior potencial para questões contextualizadas.

Para o recorte desta dissertação, o sistema foi desenvolvido e testado com foco prioritário nas
unidades de Números e Álgebra e de Probabilidade e Estatística, por duas razões: a maior cobertura da
verificação simbólica via SymPy para esses conteúdos --- equações, funções, sequências e expressões
admitem verificação determinística na maioria dos casos --- e a representatividade dessas unidades nas
avaliações externas brasileiras, em particular no ENEM. As habilidades de Geometria e Medidas que
admitem verificação simbólica --- equações de retas, circunferências e distâncias na geometria analítica
--- também foram incluídas, com as ressalvas da Seção~\ref{sub:cas-limites}.
...
As seções anteriores apresentaram quatro referenciais --- Polya, a TSD, as taxonomias de Bloom e SOLO,
...
interpretações incompatíveis, são reprovadas neste critério, pois violam a exigência de Polya de
...
heurística de Polya. À luz da TSD, a ambiguidade empobrece o \emph{milieu}: quando o estudante não
...
\midrule
Correção matemática & Polya; SymPy & Verificador Simbólico & Binário (aprovado / rejeitado) \\
Clareza do enunciado & Polya; TSD & Crítico Didático & Escala + comentário \\
...
Originalidade e relevância & TSD; Polya & Crítico Didático & Escala descritiva (3 pontos) \\
\bottomrule
\end{tabular}
...
Os seis critérios formam a rubrica operacional do sistema e serão retomados no capítulo de avaliação
