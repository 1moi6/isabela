...
O recorte não é, contudo, uma linha entre habilidades verificáveis e não verificáveis. Duas das
dez adotadas --- \texttt{EM13MAT401} e \texttt{EM13MAT402} --- pedem converter representações
algébricas em geométricas, e o que a habilidade cobra aí é uma propriedade do enunciado, não do
cálculo: nenhum sistema de computação algébrica decide se a questão de fato exige a conversão de
registro. Elas integram o recorte declarando conferência apenas parcial, conforme a garantia
discutida na Seção~\ref{sec:garantia}. Esse é o critério que permite, adiante, ampliar o catálogo
sem que nenhuma habilidade prometa mais do que entrega.
