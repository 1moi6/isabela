...
organiza o trabalho em três áreas: \emph{gerar questão} (o formulário de especificação e o
acompanhamento do ciclo, com os veredictos de cada agente); \emph{banco} (consulta com filtros
ao acervo aprovado); e \emph{montar lista} (seleção por filtros e exportação em Markdown ou
LaTeX, nas versões do aluno e do professor).
